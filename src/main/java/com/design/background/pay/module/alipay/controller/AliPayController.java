package com.design.background.pay.module.alipay.controller;
    ...
    public void notifyUrl(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (signVerified) {
            ...
            if (!alipayProerties.getAppId().equals(params.get(AliPayConstants.APP_ID))) {
                ...
                } else if (status.equals(AliPayConstants.RADE_SUCCESS) || status.equals(AliPayConstants.TRADE_FINISHED)) {
                    // 如果状态是已经支付成功
